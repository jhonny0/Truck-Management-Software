...
import View.JDialogManagementOutOfState;

import java.util.ArrayList;
import java.util.GregorianCalendar;


public class PresenterManagementOutOfState {
    private Handler handler ;
    private JDialogManagementOutOfState view ;
    private MainPresenter mainPresenter ;

    public PresenterManagementOutOfState (Handler handler) {
        this.handler = handler;

    }
    public void init (MainPresenter presenter){
        this.view = new JDialogManagementOutOfState(this);
        this.loadData() ;
    ...
    public void loadData(){
        ...
        try {
            ...
            for (int travel = 0 ; travel < listTravel.size(); travel++){
                ...
                if (actualTravel instanceof OutStateTravel)
    ...
    public void addTravel(){
        try {
            ...
            OutStateTravel travel = new OutStateTravel(codeID,milesToTravel,trucks,driver,dateAndTime,duration,destination);
    ...
    public void fillFields(String idTravel){
        try {
            OutStateTravel travel = (OutStateTravel) this.handler.travelPerIDTravel(idTravel);
    ...
    public void updateTravel(String idTravel){
        try {
            ...
            short duration = this.view.getDuration();
            String destination = this.view.getDestination();
            OutStateTravel travelUpdated = new OutStateTravel(codeID, milesToTravel,trucks,driver,dateAndTime,duration,destination);
